...
export default function AdminCMSPage() {
  const home = useCMSSection(
  AdminService.getHomePageContent,
  AdminService.createHomePageContent,
  AdminService.updateHomePageContent,
  D.home, 'Home content saved!'
);
const about = useCMSSection(
  AdminService.getAboutPageContent,
  AdminService.createAboutPageContent,
  AdminService.updateAboutPageContent,
  D.about, 'About content saved!'
);

const contact = useCMSSection(
  AdminService.getContactContent,
  AdminService.createContactContent,
  AdminService.updateContactContent,
  D.contact, 'Contact details saved!'
);
...
const upi = useCMSSection(
  AdminService.getUpiContent,
  (d) => AdminService.createUpiContent(d, upiQRFile),
  (d) => AdminService.updateUpiContent(d, upiQRFile),
  D.upi, 'UPI details saved!'
);

const bank = useCMSSection(
  AdminService.getBankContent,
  (d) => AdminService.createBankContent(d, bankQRFile),
  (d) => AdminService.updateBankContent(d, bankQRFile),
  D.bank, 'Bank details saved!'
);
